...
<body>
		...
		<jsp:useBean id="cust" class="com.simplilearn.beans.Customer">
			...
			<jsp:setProperty name="cust" property="cname" value="Uday"/>
			<jsp:setProperty name="cust" property="email" value="uday@simplilearn.com"/>
			<jsp:setProperty name="cust" property="phone" value="9876124"/>
