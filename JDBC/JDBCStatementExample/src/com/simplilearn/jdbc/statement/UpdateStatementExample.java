	...
	public static void main(String[] args) {
		...
		try {
			...
			//4. Prepare the Query & Execute
			 int record= stmt.executeUpdate("UPDATE Employees SET firstName='sharjil' where id=107");
			
			 if(record>0) {
				 System.out.println("data Updated Successfully in to Employees table");
			 }else {
				 System.err.println("Error occured while Updating the data in to Employees table");
			 }
